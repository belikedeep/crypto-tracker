          ...
          <div>
            <div className="coindata">
              <div className="desc">
                ...
                <h3 className="mt-4">
                  {coins.name} <small>({coins.symbol.toUpperCase()})</small>
                </h3>
            ...
            <div className="pricechange mt-4">
              ...
              <span className="col">
                <span>7d</span>
                <span>
                  {coins.market_data.price_change_percentage_7d.toFixed(2)}
                </span>
              </span>
              <span className="col">
                <span>14d</span>
              ...
              <span className="col">
                <span>1Y</span>
                <span>
                  {coins.market_data.price_change_percentage_1y.toFixed(2)}
                </span>
              </span>
            </div>
